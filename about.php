						...
						<div class="row">
							...
							<div class="col-lg-6 col-md-6">
								<div class="list-box d-flex">
									...
									<div class="content">
										<h3>Reembolsos rápidos</h3>
										<p>Tu satisfacción es nuestra prioridad. Procesamos devoluciones de forma ágil y sin complicaciones.</p>
									</div>
								</div>
							</div>
						</div>
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-lg-3 col-md-6">
					<div class="single-team-item">
						<div class="team-img">
							<img src="" alt="Sofía Urrutia" class="img-fluid">
						</div>
				...
				<div class="col-lg-10 offset-lg-1 text-center">
					<div class="testimonial-sliders">
						...
						<div class="single-testimonial-slider">
							...
							<div class="client-meta">
								<h3>Jacob Sikim <span>Cliente satisfecho</span></h3>
								<p class="testimonial-body">"Las joyas son tal como se ven en la página. Brillan con estilo y distinción."</p>
								<div class="last-icon">
									<i class="fas fa-quote-right"></i>
								</div>
							</div>
