                ...
                <div class="col-md-12">
                    <div class="product-filters">
                        <ul>
							...
							<li data-filter=".relojes">Relojes</li>
							<li data-filter=".joyas">Joyas</li>
			...
			<div class="row product-lists">
				<div class="col-lg-4 col-md-6 text-center strawberry">
					<div class="single-product-item">
						...
						<h3>Reloj Clásico de Pulsera</h3>
						<p class="product-price"><span>Precio</span> $185 </p>
				...
				<div class="col-lg-4 col-md-6 text-center berry">
					<div class="single-product-item">
						...
						<h3>Collar de Plata 925</h3>
						<p class="product-price"><span>Precio</span> $120 </p>
						<a href="cart.html" class="cart-btn"><i class="fas fa-shopping-cart"></i> Añadir al carrito</a>
				...
				<div class="col-lg-4 col-md-6 text-center lemon">
					<div class="single-product-item">
						...
						<h3>Pulsera de Cuero con Broche Magnético</h3>
						<p class="product-price"><span>Precio</span> $65 </p>
						<a href="cart.html" class="cart-btn"><i class="fas fa-shopping-cart"></i> Añadir al carrito</a>
