					...
					<div class="row">
						<div class="col-lg-8 offset-lg-2 text-center">
							<div class="error-text">
								...
								<h1>¡Ups! No encontramos lo que buscas.</h1>
									<p>La página que solicitaste no existe o fue movida. Por favor, vuelve al inicio para explorar nuestra colección de relojes y joyas.</p>
									<a href="index.php" class="boxed-btn">Volver al inicio</a>
